...
export default async function DashboardPage() {
  ...
  const { data: studentsData } = await supabase.from("student_profiles").select("id, full_name").in("id", studentIds)

  const { data: teachersData } = await supabase.from("teacher_profiles").select("id, full_name").in("id", teacherIds)
